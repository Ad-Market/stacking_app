  ...
  return (
        <div className="sidebar">
          ...
          <div className="mark" onClick={dashboard}>
            <img src='https://wallet.slamcoin.io/image/slamblack.png' className="avatar" alt=""/>
          </div>
          ...
          <ul className="">
            ...
            <a className="phone" href={"phone:"+phone}>{props.phone}</a><br />
            <a className="email" href={"email:"+email}>{props.email}</a><br />
